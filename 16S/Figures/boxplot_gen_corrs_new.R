...
cols = rep('black', dim(all_VCs)[1])
cols[all_VCs$pv_chi2dof2 < 0.05] = 'red'
...
points(jitter(all_VCs$study_pair_num,factor=0.5), all_VCs$corr_Ad1d2,ylab='',pch=16,cex=1, col = cols)
...
plot(all_VCs$corr_Ad1d2, all_VCs$STE_Ad1d2)
median(all_VCs$STE_Ad1d2)
#0.3148488
