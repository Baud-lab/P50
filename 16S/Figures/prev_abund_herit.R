...
outpdf = paste0("/users/abaud/htonnele/PRJs/P50_HSrats/16S/plot/prev_abund_herit_",type,"_biomt_warmBlue.pdf"); cat("saving pdf to: ", outpdf, "\n")
pdf(outpdf, h=6, w = 6)
...
for (study in c('MI','NY','TN_behavior','TN_breeder')) { #to have one plot per cohort
	...
	plot(prevs, meds, col= cols, 
	     ...
	     las = 1, cex.lab = 1.4, cex.axis = 1.25, #main = paste('Cohort:', studytitle), 
	     pch = 16)
